Ext.define('ExtDoc.tools.controllers.ExtDocNewDocController', {
	requires: [ 'ExtDoc.views.extnewdocumentwindow.ExtDocNewDocumentWindow' ],
	extend: 'ExtDoc.tools.controllers.ExtDocAbstractActionController',
	alias: 'controller.newDocController',
		...
		if (this.hasPermission(currentFolderRecord))
		{
			...
			xhr.onloadend = function (evt){
				if (evt.target.status === 200)
				{
					...
					window.setWindowType('ExtDoc.views.extnewdocumentwindow.ExtDocNewDocumentWindow');
