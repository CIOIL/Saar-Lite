...
public class NRGovRequestFolderPropertiesFormValidation extends NRValidation implements INRValidation
{

	private static final String[] requiredFields = { NRConstants.OBJECT_NAME, NRConstants.CLASSIFICATION,
			                                         NRConstants.SENSITIVITY , NRConstants.SENDER_NAME,
			                                       };
