...
public class NRServiceExtraLinkObjectsValidation  extends NRValidation implements INRValidation
{
	private static final String[] requiredFieldsArr = {"objectIds", "linkToId"};
