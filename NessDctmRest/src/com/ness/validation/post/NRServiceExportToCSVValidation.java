...
public class NRServiceExportToCSVValidation extends NRValidation implements INRValidation
{
	
	private static final String[] requiredFieldsArr = {"columnDataIndexes", "columnNames", "objectIds"};
