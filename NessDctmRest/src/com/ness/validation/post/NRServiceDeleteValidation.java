...
public class NRServiceDeleteValidation extends NRValidation implements INRValidation
{
	...
	{	
		...
		validationObject = NRValidationUtills.validateFieldsArray(new NRValidationUtills.ValidateObjectIdsCommand(), object, requiredFieldsArr, NRConstants.VE_NOT_VALID_OBJECT_IDS);
		if (validationObject != null)
		{
			mergeValidationObject.getProperties().putAll(validationObject.getProperties());
		}
