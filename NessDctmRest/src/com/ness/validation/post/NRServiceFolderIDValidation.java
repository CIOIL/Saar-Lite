...
public class NRServiceFolderIDValidation extends NRValidation implements INRValidation
{
	private static final String[] requiredFieldsArr = {NRConstants.FOLDER_ID};
	
	private static final String[] folderIdFieldsArr = {NRConstants.FOLDER_ID};
