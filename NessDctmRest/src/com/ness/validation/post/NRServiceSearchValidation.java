...
public class NRServiceSearchValidation extends NRValidation implements INRValidation
{
	private static final String[] requiredFieldsArr = {NRConstants.ATTR_OBJECT_TYPE,
														NRConstants.ATTR_SEARCH_VALUE};
	
	private static final String[] ObjectTypeFieldsArr = {NRConstants.ATTR_OBJECT_TYPE};
