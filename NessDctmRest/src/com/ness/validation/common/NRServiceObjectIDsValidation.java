package com.ness.validation.common;
...
public class NRServiceObjectIDsValidation  extends NRValidation implements INRValidation
{
	private static final String[] requiredFieldsArr = { NRConstants.OBJECT_IDS };
